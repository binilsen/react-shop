				...
				<MComponents.Card sx={{ height: "100%" }}>
					...
					>
						...
						<MComponents.CardContent>
							<MComponents.Stack justifyContent="space-between">
								<MComponents.Typography variant="overline" component="span">
									{props.product.name}
							...
							<MComponents.Typography variant="body2" component={"div"}>
